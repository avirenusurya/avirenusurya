...
**AI Engineer in the making — I build agents, RAG systems, and AI products that actually ship.**
...
**AI / ML** · PyTorch, Transformers, scikit-learn, SHAP, LLMs (Gemini / OpenRouter), RAG, prompt engineering
**Backend** · FastAPI, REST APIs, Pydantic
**Frontend** · React, Vite, Tailwind CSS
**Data / infra** · Supabase / Postgres, pgvector, Render, Vercel, Git

## 📈 A bit more

- 🏆 **National Finalist — Top 2% of 40,000+** participants, India AI Impact Buildathon (GUVI × HCL), Feb 2026
- 🛡️ Built a 6-domain explainable-AI cyber-defense platform at IndiaNext Hackathon 2026
- 🎓 IIT Madras — BS in Data Science & Applications
- 🌱 Currently building an agentic RAG system end-to-end

---

<sub>📫 Reach me on <a href="https://www.linkedin.com/in/avirenusurya/">LinkedIn</a>.</sub>
